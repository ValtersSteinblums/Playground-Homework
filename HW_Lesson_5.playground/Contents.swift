...
class Orange {
    ...
    init(fruitColor: String, taste: String, weight: Double) {
...
let someOrange = Orange(fruitColor: "Orange", taste: "Sweet", weight: 0.66)
print(" My \(someOrange.weight) kg orange has \(someOrange.fruitColor) color and \(someOrange.taste) taste.")
...
let myRectangle = Rectangle(height: 12, width: 13)
